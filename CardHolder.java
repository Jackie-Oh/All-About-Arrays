...
public class CardHolder{
	...
	*/
	...
	private static int memNum=1000;//static variable for the membership number.
	
	/**
	An array to store up to 8 kitchen tool items.
	*/
	private LendingItem [] items = new LendingItem [8];
	...
	*/
	public CardHolder(String name,int aptNum , String phoneNum){
		...
		*/
		public boolean signOut(LendingItem itemToTakeOut){
		...
		*/
		...
		public boolean returnItem(LendingItem itemToReturn){
			boolean result = false;
			...
			*/
			...
			LendingItem [] copylist = new LendingItem[lenNum];
